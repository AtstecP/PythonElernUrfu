            ...
            for hour in range(0, 22):
                for page in range(0, 20):
                    vacancies = get_page(page, f'{f"0{hour}" if hour < 10 else hour}:00:00',
                                         f'{f"0{hour + 1}" if hour + 1 < 10 else hour + 1}:00:00', date,text)
                    if vacancies.__contains__('items'):
                        ...
                        print(f'{f"0{hour}" if hour < 10 else hour}:00:00' jf'{f"0{hour + 1}" if hour + 1 < 10 else hour + 1}:00:00')
